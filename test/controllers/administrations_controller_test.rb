...
class AdministrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administration" do
    assert_difference('Administration.count') do
      post administrations_url, params: { administration: { city: @administration.city, name: @administration.name, phone_number: @administration.phone_number, province: @administration.province, street: @administration.street, user_id: @administration.user_id } }
    end
  ...
  test "should update administration" do
    patch administration_url(@administration), params: { administration: { city: @administration.city, name: @administration.name, phone_number: @administration.phone_number, province: @administration.province, street: @administration.street, user_id: @administration.user_id } }
